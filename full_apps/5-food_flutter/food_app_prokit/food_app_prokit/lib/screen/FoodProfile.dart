                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Row(
                            children: <Widget>[
                              Expanded(
                                  child: foodEditTextStyle(food_hint_first_name,
                                      TextInputType.text)),
                              SizedBox(width: 16),
                              Expanded(
                                  child: foodEditTextStyle(
                                      food_hint_last_name, TextInputType.text))
                            ],
                          ),
                          SizedBox(height: 16),
                          Container(
                          ...
                          SizedBox(height: 16),
                          foodEditTextStyle(
                              food_hint_mobile_no, TextInputType.number),
                          SizedBox(height: 16),
                          foodEditTextStyle(
                              food_hint_email, TextInputType.emailAddress),
                          SizedBox(height: 16),
                          Container(
                            width: MediaQuery.of(context).size.width,
