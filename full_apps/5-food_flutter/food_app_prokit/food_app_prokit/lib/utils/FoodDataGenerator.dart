...
List<DashboardCollections> addCollectionData() {
  ...
  collectionData.add(
      DashboardCollections("Fried Rings", food_ic_item4, "Starts from @E123"));
  collectionData.add(DashboardCollections(
      "Butter Croissant", food_ic_item11, "Starts from @E123"));
  collectionData.add(
      DashboardCollections("Milk Toast", food_ic_item6, "Starts from @E123"));
  collectionData.add(
      DashboardCollections("Fried Rings", food_ic_item4, "Starts from @E123"));
...
List<Restaurants> addBakeryData() {
  ...
  bakeryData.add(
      Restaurants("Bakery & Toast Shop", 4, food_ic_popular2, "50 Reviews"));
  bakeryData.add(
      Restaurants("Pastries & Cup Cake Shop", 2, food_ic_item12, "50 Reviews"));
  bakeryData
      .add(Restaurants("Ice-Creams & Sundaes", 5, food_ic_item1, "50 Reviews"));
  bakeryData.add(Restaurants(
      "Refreshing Cold-Drinks Shop", 4, food_ic_item13, "50 Reviews"));
  return bakeryData;
}
...
List<Restaurants> addDeliveryRestaurantsData() {
  ...
  deliveryRestaurantsData
      .add(Restaurants("Restro Bistro", 4, food_ic_popular4, "50 Reviews"));
  deliveryRestaurantsData
      .add(Restaurants("Burger Bites", 2, food_ic_popular3, "50 Reviews"));
  deliveryRestaurantsData
      .add(Restaurants("Cream N Ice", 5, food_ic_item1, "50 Reviews"));
  deliveryRestaurantsData
      .add(Restaurants("Break the Fast", 4, food_ic_item6, "50 Reviews"));
...
List<Restaurants> addCafeData() {
  ...
  cafeData
      .add(Restaurants("Vegetable Risotto", 5, food_ic_item10, "50 Reviews"));
...
List<DashboardCollections> addCuisineData() {
  ...
  cuisineData
      .add(DashboardCollections("Americano", food_ic_item6, "100+ Experience"));
  cuisineData.add(
      DashboardCollections("Continental", food_ic_item4, "50+ Experience"));
  cuisineData
      .add(DashboardCollections("Italian", food_ic_item11, "20+ Experience"));
  cuisineData
      .add(DashboardCollections("American", food_ic_item6, "100+ Experience"));
...
List<FoodDish> addFoodDishData() {
  ...
  dishData
      .add(FoodDish("Milk Toasts", "American", "Veg", food_ic_item6, "\$50"));
  dishData.add(
      FoodDish("Toast Sandwiches", "Indian", "Veg", food_ic_popular2, "\$50"));
  dishData.add(FoodDish("Burgers", "Italian", "Veg", food_ic_popular3, "\$50"));
  dishData.add(
      FoodDish("Espresso Coffee", "Italian", "Veg", food_ic_item10, "\$50"));
...
List<FoodDish> orderData() {
  ...
  dishData.add(FoodDish(
      "Milk Toasts", "25 Jan 2019, 10:00 PM", "Veg", food_ic_item6, "\$20"));
  dishData.add(FoodDish("Cappuccino Coffee", "20 May 2019, 08:00 PM, 10:00 PM",
      "Veg", food_ic_item10, "\$50"));
  dishData.add(FoodDish(
      "Ice-Cream", "25 Jan 2019, 10:00 PM", "Veg", food_ic_item1, "\$25"));
