...
import 'package:food_app/utils/FoodColors.dart';
import 'package:food_app/utils/FoodDataGenerator.dart';
import 'package:food_app/utils/FoodImages.dart';
import 'package:food_app/utils/FoodString.dart';
import 'package:food_app/utils/FoodWidget.dart';
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        food_lbl_gravity_spacebar,
                        style: primaryTextStyle(size: 20),
                      ),
                      Row(
                        children: <Widget>[
                          Text(
                            food_lbl_gurugram_sector_19,
                            style: primaryTextStyle(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        food_lbl_plan_your_visit.toUpperCase(),
                        style: primaryTextStyle(),
                      ),
                      SizedBox(height: 8),
                      iconWithTitle(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        food_lbl_user_review.toUpperCase(),
                        style: primaryTextStyle(),
                      ),
                      SizedBox(height: 16),
                      Row(
                      ...
                      SizedBox(height: 16),
                      Text(
                        food_lbl_what_guest_are_saying.toUpperCase(),
                        style: primaryTextStyle(),
                      ),
                      ListView.builder(
                        scrollDirection: Axis.vertical,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      SizedBox(height: 16),
                      Text(
                        food_lbl_additional_detail.toUpperCase(),
                        style: primaryTextStyle(),
                      ),
                      SizedBox(height: 16),
                      iconWithTitle(
