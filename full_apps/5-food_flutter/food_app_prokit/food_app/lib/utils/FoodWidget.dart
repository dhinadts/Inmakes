...
import 'package:food_app/screen/FoodAddAddress.dart';
...
Padding foodEditTextStyle(var hintText, keyboardType) {
  return Padding(
    ...
    child: Row(
      children: <Widget>[
        Text(
          title,
          style: boldTextStyle(
            color: color ?? appStore.textPrimaryColor,
            size: 20,
          ),
          maxLines: 1,
        ).expand(),
